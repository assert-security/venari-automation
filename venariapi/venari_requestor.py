...
class VenariRequestor(object):
    ...
    def request(self,json=None,params=None)->VenariResponse:
        ...
        return RequestHelper.request(method=self.method,authToken=self.auth.access_token,endpoint=self.endpoint,json=json,params=params,verify_ssl=self.verify_ssl)
